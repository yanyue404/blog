...
new VConsole({
  onReady: () => {
    var _vconsle_dom = document.getElementById('__vconsole');
      if (_vconsle_dom) {
        _vconsle_dom.classList.add('rr-ignore');
        _vconsle_dom.classList.add('rr-block');
        _vconsle_dom.classList.add('txr-ignore');
        _vconsle_dom.classList.add('txr-block');
      }
    }
})