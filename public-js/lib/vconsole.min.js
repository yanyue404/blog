...
new VConsole({onReady:function(){var _vconsle_dom=document.getElementById('__vconsole');if(_vconsle_dom){_vconsle_dom.classList.add('rr-ignore');_vconsle_dom.classList.add('rr-block');_vconsle_dom.classList.add('txr-ignore');_vconsle_dom.classList.add('txr-block');}},pluginConfig:{'Network':{reqExclude:[/reciveFrontEndResourceToS3|appendVideo|healthcare|\.(?:png|jpe?g|css|js|json|gif|ico|woff2)/i]}}})
